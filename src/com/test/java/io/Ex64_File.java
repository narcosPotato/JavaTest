...
//		File dir = new File("C:\\class\\code\\java\\aaa");
	...
	private static void m2() {
		...
		if (dir.exists()) {
			...
			System.out.println(dir.getAbsolutePath());	//경로 C:\class\code\java\file
	...
	private static void m1() {
		...
		if (file.exists()) {
			...
			System.out.println(file.length());			//25 > 파일 크기(바이트)
			System.out.println(file.getAbsolutePath());	//경로 C:\class\code\java\file\data.txt
			
			System.out.println(file.lastModified());	//수정한 날짜 1691379568433
